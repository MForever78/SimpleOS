...
xst -ifn xst.scr
move dsp_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dsp_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dsp_exdes.ucf dsp_exdes

echo 'Running map'
map -timing -pr b dsp_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dsp_exdes -w routed.ncd routed.v
cd ..
