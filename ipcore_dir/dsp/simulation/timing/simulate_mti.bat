...
vlog -work work dsp_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax dsp_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.dsp_tb work.glbl
