# 
# Project automation script for SimpleOS 
# 
...
proc add_source_files {} {
   ...
   xfile add "Sword_Original.ucf"
   xfile add "font_device.v"
   xfile add "ipcore_dir/dsp.xco"
   xfile add "ipcore_dir/font_table.xco"
   xfile add "ipcore_dir/ram_ipcore.xco"
   xfile add "ipcore_dir/vram_ipcore.xco"
   xfile add "src/ADC32.v"
   xfile add "src/ALU.v"
   xfile add "src/CP0.v"
   xfile add "src/Ext_32.v"
   xfile add "src/MDR_BYTE.v"
   ...
   xfile add "src/SimpleOS.v"
   xfile add "src/WB_intercon.v"
   xfile add "src/and32.v"
   xfile add "src/board_disp_sword.v"
   xfile add "src/btn_scan_sword.v"
   xfile add "src/counter.v"
   xfile add "src/ctrl.v"
   xfile add "src/data_path.v"
   xfile add "src/dec4to16.v"
   xfile add "src/disk.v"
   xfile add "src/disk_addr_gen.v"
   xfile add "src/disk_dev.v"
   xfile add "src/display_select.v"
   xfile add "src/keyboard.v"
   xfile add "src/muliti_cpu.v"
   xfile add "src/mux16to1_32.v"
   xfile add "src/mux2to1_32.v"
   xfile add "src/mux4to1_32.v"
   xfile add "src/mux4to1_5.v"
   xfile add "src/nor32.v"
   xfile add "src/or32.v"
   xfile add "src/or_bit_32.v"
   xfile add "src/parallel2serial.v"
   xfile add "src/pause_gen.v"
   xfile add "src/ps2_kbd.v"
   xfile add "src/sll32.v"
   xfile add "src/sllv32.v"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/mforever78/Share/Xilinx/SimpleOS/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "SimpleOS" -process "Generate IBIS Model"
